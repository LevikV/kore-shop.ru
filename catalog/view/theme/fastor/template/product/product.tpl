			        ...
			        <div class="add-to-cart clearfix">
			          ...
			          if( count($product_enquiry) ) { 
			          	foreach ($product_enquiry as $module) {
     			          ...
     			          <div class="my_quantity" style="float: left;margin: 4px 10px 0px 0 !important;border-radius: 25px !important;"> 
                           <span class="my_minus">-</span>
                            <input type="text" name="quantity" class="quant" value="1" size="5" id="input-quantity"class="form-control" style="float: none;display: inline;padding: 1px;margin: 4px 0px 0px 0px !important;width: 50px;height: 33px;"/>
